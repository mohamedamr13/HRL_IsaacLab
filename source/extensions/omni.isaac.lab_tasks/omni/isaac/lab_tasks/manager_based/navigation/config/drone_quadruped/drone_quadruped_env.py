...
class ObservationsCfg:
    ...
    class MultiAgentPolicyCfg(ObsGroup):
        ...
        base_lin_vel_drone = ObsTerm(func=mdp.base_lin_vel, params={'asset_cfg': drone_cfg_scene_entity})
        base_ang_vel_drone = ObsTerm(func=mdp.base_ang_vel, params={'asset_cfg': drone_cfg_scene_entity})
        projected_gravity_drone = ObsTerm(func=mdp.projected_gravity, params={'asset_cfg': drone_cfg_scene_entity})
        desired_pos_base_drone = ObsTerm(func=mdp.desired_pos_b, params={'asset_cfg': drone_cfg_scene_entity})
...
@configclass
class DroneQuadrupedEnvCfg(ManagerBasedRLEnvCfg):
...
class DroneQuadrupedEnvCfg_PLAY(DroneQuadrupedEnvCfg):
